...
public final class ApiClientImpl implements ApiClient {
  ...
  public ApiClientImpl(ClientOptions clientOptions) {
  ...
  public SharedApiClientAccessToken getApiClientAccessToken(
    ...
    HttpUrl.Builder _httpUrlBuilder = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      _requestBodyProperties.put("secret", request.getSecret());
      ...
      try {
        ...
        if (_response.isSuccessful()) {
          return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), SharedApiClientAccessToken.class);
        }
