...
public final class ProductClientImpl implements ProductClient {
  private final ClientOptions clientOptions;

  public ProductClientImpl(ClientOptions clientOptions) {
  ...
  public List<SharedWorkloadProduct> listProductsByPartner(String orgId,
    ...
    try {
      ...
      if (_response.isSuccessful()) {
        return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), new TypeReference<List<SharedWorkloadProduct>>() {});
      }
  ...
  public SharedWorkloadProduct getProduct(String orgId, String productId) {
    ...
    try {
      Response _response = clientOptions.httpClient().newCall(_request).execute();
      if (_response.isSuccessful()) {
        return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), SharedWorkloadProduct.class);
      }
      throw new RuntimeException();
    }
    catch (Exception e) {
  ...
  public SharedWorkloadProduct updateProduct(String orgId, String productId,
    ...
    HttpUrl.Builder _httpUrlBuilder = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      _requestBodyProperties.put("fulfillmentUrl", request.getFulfillmentUrl());
    ...
    public List<SharedAwsSaasProductDimension> listProductMeteringDimensions(String orgId,
      ...
      try {
        Response _response = clientOptions.httpClient().newCall(_request).execute();
        if (_response.isSuccessful()) {
          return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), new TypeReference<List<SharedAwsSaasProductDimension>>() {});
        }
        throw new RuntimeException();
      }
      catch (Exception e) {
