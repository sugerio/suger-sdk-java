...
@JsonDeserialize(
    builder = ListRevenueRecordsRequest.Builder.class
)
public final class ListRevenueRecordsRequest {
  ...
  ListRevenueRecordsRequest(Optional<String> productId, Optional<String> entitlementId,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListRevenueRecordsRequest && equalTo((ListRevenueRecordsRequest) other);
  }

  private boolean equalTo(ListRevenueRecordsRequest other) {
  ...
  public String toString() {
    return "ListRevenueRecordsRequest{" + "productId: " + productId + ", entitlementId: " + entitlementId + ", buyerId: " + buyerId + ", startDate: " + startDate + ", endDate: " + endDate + ", limit: " + limit + ", offset: " + offset + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(ListRevenueRecordsRequest other) {
    ...
    public ListRevenueRecordsRequest build() {
      return new ListRevenueRecordsRequest(productId, entitlementId, buyerId, startDate, endDate, limit, offset);
    }
  }
}
