...
@JsonDeserialize(
    builder = GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageBatchEventOkMessage.Builder.class
)
public final class GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageBatchEventOkMessage {
  private final Optional<String> dimension;

  private final Optional<String> effectiveStartTime;

  private final Optional<GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventConflictResponse> error;
  ...
  GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageBatchEventOkMessage(
      Optional<String> dimension, Optional<String> effectiveStartTime,
      Optional<GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventConflictResponse> error,
      Optional<String> messageTime, Optional<String> planId, Optional<Double> quantity,
      Optional<String> resourceId, Optional<String> resourceUri,
  ...
  @JsonProperty("error")
  public Optional<GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventConflictResponse> getError(
      ) {
    return error;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageBatchEventOkMessage && equalTo((GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageBatchEventOkMessage) other);
  }

  private boolean equalTo(
      GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageBatchEventOkMessage other) {
    return dimension.equals(other.dimension) && effectiveStartTime.equals(other.effectiveStartTime) && error.equals(other.error) && messageTime.equals(other.messageTime) && planId.equals(other.planId) && quantity.equals(other.quantity) && resourceId.equals(other.resourceId) && resourceUri.equals(other.resourceUri) && status.equals(other.status) && usageEventId.equals(other.usageEventId);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.dimension, this.effectiveStartTime, this.error, this.messageTime, this.planId, this.quantity, this.resourceId, this.resourceUri, this.status, this.usageEventId);
    }
  ...
  public String toString() {
    return "GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageBatchEventOkMessage{" + "dimension: " + dimension + ", effectiveStartTime: " + effectiveStartTime + ", error: " + error + ", messageTime: " + messageTime + ", planId: " + planId + ", quantity: " + quantity + ", resourceId: " + resourceId + ", resourceUri: " + resourceUri + ", status: " + status + ", usageEventId: " + usageEventId + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventConflictResponse> error = Optional.empty();
    ...
    public Builder error(
        GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventConflictResponse error) {
    ...
    public GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageBatchEventOkMessage build(
        ) {
      return new GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageBatchEventOkMessage(dimension, effectiveStartTime, error, messageTime, planId, quantity, resourceId, resourceUri, status, usageEventId);
    }
  }
}
